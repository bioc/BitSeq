...
void Sampler::init(long m, long samplesTotal, long samplesOut, long Nmap, long Nunmap, const vector<long> &alignI, const vector<TagAlignment> &alignments, const distributionParameters &betaPar, const distributionParameters &dirPar, long seed){//{{{
//   this->n=n;
   this->m=m;
...
void Sampler::saveSamples(ofstream *outFile, const vector<long double> *isoformLengths, outputType saveType, double norm){//{{{
